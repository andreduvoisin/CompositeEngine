...
int main(int argc, char* argv[])
{
	...
	// Load some shaders.
	GLuint vertexShader = LoadShader(GL_VERTEX_SHADER, "../../../src/shaders/simpleShader.vert");
	GLuint fragmentShader = LoadShader(GL_FRAGMENT_SHADER, "../../../src/shaders/simpleShader.frag");
