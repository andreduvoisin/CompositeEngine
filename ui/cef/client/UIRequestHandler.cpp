...
UIRequestHandler::UIRequestHandler(const CefRefPtr<CefMessageRouterBrowserSide>& messageRouterBrowserSide)
    : messageRouterBrowserSide(messageRouterBrowserSide)
{
}

void UIRequestHandler::OnRenderProcessTerminated(CefRefPtr<CefBrowser> browser, TerminationStatus /*status*/)
{
